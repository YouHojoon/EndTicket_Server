...
class HistoryRepositoryTest
    ...
    constructor(
        ...
        fun given_specificIdAndType_when_findBySpecificIdAndType_then_returnHistory(
            history: History,
            specificId: Long,
            type: History.Type,
        ) {
        ...
        @MethodSource("${HistoryTestParameters.PATH}#provideHistoryAndSpecificIdAndType")
        fun given_specificIdAndType_existsSpecificIdAndType_then_returnIsExists(
            history: History,
            specificId: Long,
            type: History.Type,
        ) {
        ...
        fun given_userIdAndType_findAllByUserIdAndType_then_returnHistories(
            histories: Collection<out History>,
            type: History.Type,
        ) {
        ...
        fun given_userId_when_countEachHistoryByUserId_then_returnHistoryCount(
            ticketHistories: Set<TicketHistory>,
            imaginationHistories: Set<ImaginationHistory>,
        ) {
