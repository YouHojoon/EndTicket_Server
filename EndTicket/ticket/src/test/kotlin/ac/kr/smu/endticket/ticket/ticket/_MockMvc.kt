...
fun MockMvc.createTicket(
    request: TicketRequest,
    userId: Long = TicketTestParameters.USER_ID,
) = perform(
...
fun MockMvc.swipeTicket(
    id: Long,
    userId: Long = TicketTestParameters.USER_ID,
) = perform(
    MockMvcRequestBuilders
        .patch("$BASE_URI/swipe/$id")
        .header(HttpHeaderName.USER_ID, userId),
)

fun MockMvc.cancelSwipeTicket(
    id: Long,
    userId: Long = TicketTestParameters.USER_ID,
) = perform(
    MockMvcRequestBuilders
        .delete("$BASE_URI/swipe/$id")
        .header(HttpHeaderName.USER_ID, userId),
)

fun MockMvc.deleteTicket(
    id: Long,
    userId: Long = TicketTestParameters.USER_ID,
) = perform(
    MockMvcRequestBuilders
