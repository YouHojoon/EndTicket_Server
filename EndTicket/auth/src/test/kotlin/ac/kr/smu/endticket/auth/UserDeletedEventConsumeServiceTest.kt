...
//        RedisRefreshTokenService::class,
...
//    constructor(
//        @MockBean
//        private val tokenService: RedisRefreshTokenService,
...
//            Thread.sleep(1000)
//
//            Mockito.verify(tokenService).removeByUserId(AuthTestParameters.USER_ID.toString())
//        }
//    }
