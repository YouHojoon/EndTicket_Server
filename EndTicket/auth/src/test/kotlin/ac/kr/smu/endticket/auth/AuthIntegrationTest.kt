...
//import ac.kr.smu.endTicket.auth.infra.oauth2.OAuth2ServiceImpl
...
//
//        @Test
//        @DisplayName("SNS 종류와 인증 코드로 access 토큰을 요청한다.")
//        fun given_socialTypeAndAuthorizationCode_when_createToken_then_responseAccessTokenAndRefreshToken() {
//            mvc
//                .createToken()
...
//
//        @Test
//        @DisplayName("토큰 생성 시에 사용자 서비스와 통신 실패하면 503 에러를 반환한다.")
...
//
//        @Test
//        @DisplayName("만료된 사용자가 토큰 갱신 요청하면 401 에러를 반환한다.")
//        fun given_expiredUser_when_reissueToken_then_responseExceptionResponseWithStatus401() {
//            val refreshToken =
//                mvc
//                    .createToken()
