...
object UserTestParameters {
    ...
    fun provideUser() =
        Stream.of(
            Arguments.of(
                User(SOCIAL_TYPE, SOCIAL_USER_NUMBER).also {
                    it.registerNickname(
                        NicknameRegisterRequest(NICKNAME),
                    )
                },
            ),
        )
    ...
    @JvmStatic
    fun provideInvalidUserAndException() =
        Stream.of(
            Arguments.of(
                User(SOCIAL_TYPE, SOCIAL_USER_NUMBER).also {
                    it.registerNickname(
    ...
    @JvmStatic
    fun provideInvalidNicknameRegisterRequest() =
        Stream.of(
    ...
    @JvmStatic
    fun provideNicknameRegisterRequestAndException() =
        Stream.of(
