...
class UserControllerTest
    ...
    constructor(
        ...
        fun given_invalidUser_when_registerNickname_then_responseExceptionResponseWithExpectedStatus(
            ...
            Mockito
                .`when`(service.registerNickname(request, UserTestParameters.USER_ID))
        ...
        fun given_id_when_findNickname_then_responseNickname() {
            Mockito
                .`when`(service.findNickname(UserTestParameters.USER_ID))
        ...
        fun given_idOfNonExistentUser_when_deleteUser_then_responseExceptionResponseWithStatus404() {
            Mockito
                .`when`(service.deleteUser(Mockito.anyLong()))
                .thenThrow(UserNotFoundException(UserTestParameters.USER_ID))
