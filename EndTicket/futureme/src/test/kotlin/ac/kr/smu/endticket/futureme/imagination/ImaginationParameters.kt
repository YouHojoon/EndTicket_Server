...
object ImaginationParameters {
    ...
    @JvmStatic
    fun provideImagination() = Stream.of(
        Arguments.of(Imagination.from(REQUEST, USER_ID))
    )

    @JvmStatic
    fun provideImaginations() = Stream.of(
        Arguments.of(setOf(Imagination.from(REQUEST, USER_ID)))
    )

    @JvmStatic
    fun provideImaginationResponses() = Stream.of(
    ...
    @JvmStatic
    fun provideInvalidImagination() = Stream.of(
        Arguments.of(
            Imagination.from(REQUEST, USER_ID),
            2L,
            ImaginationOwnershipException::class
    ...
    @JvmStatic
    fun provideInvalidImaginationRequest() = Stream.of(
        Arguments.of(INVALID_BEHAVIOR_REQUEST), Arguments.of(INVALID_TARGET_REQUEST)
    )

    @JvmStatic
    fun provideImaginationResponseAndRequest() = Stream.of(
        Arguments.of(
            Imagination.from(REQUEST, USER_ID).toResponse(), REQUEST
        )
    )

    @JvmStatic
    fun provideInvalidIdAndRequest() = Stream.of(
