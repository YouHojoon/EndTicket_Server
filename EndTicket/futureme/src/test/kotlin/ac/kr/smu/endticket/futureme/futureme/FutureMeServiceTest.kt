...
class FutureMeServiceTest(
    ...
    fun given_request_when_updateFutureMe_then_returnUpdatedFutureMe() {
        ...
        Mockito
            .`when`(repo.findById(FutureMeTestParameters.USER_ID))
    ...
    fun given_userIdDoesNotHaveFutureMe_when_updateFutureMe_then_throwFutureMeNotFoundException() {
        ...
        assertThrows<FutureMeNotFoundException> {
            service.updateFutureMe(
                FutureMeTestParameters.UPDATE_REQUEST,
                FutureMeTestParameters.USER_ID,
            )
        }
    }
    ...
    fun given_requestWithAlreadyExistFutureMe_when_createFutureMe_then_throwIllegalStateException() {
        ...
        assertThrows<IllegalStateException> {
            service.createFutureMe(
                CreateFutureMeRequest(CharacterType.CHEESE),
                FutureMeTestParameters.USER_ID,
            )
        }
    }
