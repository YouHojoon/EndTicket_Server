...
class ImaginationIntegrationTest
    @Autowired
    constructor(
        ...
        private val mvc: MockMvc =
            MockMvcBuilders.standaloneSetup(controller).setControllerAdvice(BindExceptionAdvice()).build()
        ...
        fun given_request_when_updateImagination_then_responseUpdatedImagination() {
            ...
            mvc
                .updateImagination(ImaginationParameters.UPDATE_REQUEST, imagination.id, ImaginationParameters.USER_ID)
                .andExpect(MockMvcResultMatchers.status().isOk)
        ...
        fun given_invalidRequest_when_updateImagination_then_responseBindExceptionResponseWithStatus400(request: ImaginationRequest) {
            ...
            mvc
                .updateImagination(request, imagination.id, ImaginationParameters.USER_ID)
                .expectBindException()
        }
        ...
        fun given_notExistsImaginationId_when_updateImagination_then_responseExceptionResponseWithStatus404() {
            mvc
                .updateImagination(ImaginationParameters.REQUEST, 1L, ImaginationParameters.USER_ID)
        ...
        fun given_userIdWhoNotOwner_when_updateImagination_then_responseExceptionResponseWithStatus403() {
            val imagination =
                mvc
                    .createImagination(ImaginationParameters.REQUEST, ImaginationParameters.USER_ID)
                    .andReturn<ImaginationResponse>()

            mvc
                .updateImagination(ImaginationParameters.REQUEST, imagination.id, 2L)
        ...
        fun given_id_when_deleteImagination_then_expectStatus204() {
            ...
            mvc
                .deleteImagination(imagination.id)
        ...
        fun given_userWhoNotOwner_when_deleteImagination_then_responseExceptionResponseWithStatus403() {
            ...
            mvc
                .deleteImagination(imagination.id, 2L)
                .andExpect(MockMvcResultMatchers.status().isForbidden)
                .expectExceptionResponse()
        }
        ...
        fun given_id_when_completeImagination_then_expectStatusCode204_and_sendImaginationCompletionEventAndGainExperiencePoints() {
            val container: KafkaMessageListenerContainer<String, ImaginationCompletedEventResponse> =
                createKafkaContainer(broker, KafkaTopic.IMAGINATION_COMPLETED)
            ...
            mvc
                .completeImagination(imagination.id)
                .andExpect(MockMvcResultMatchers.status().isNoContent)
        ...
        fun given_userWhoNotOwner_when_completeImagination_then_responseExceptionResponseWithStatus403() {
            ...
            mvc
                .completeImagination(imagination.id, 2L)
                .andExpect(MockMvcResultMatchers.status().isForbidden)
                .expectExceptionResponse()
        }
    }
