...
fun MockMvc.findImaginations(userId: Long = ImaginationParameters.USER_ID) =
    perform(
...
fun MockMvc.createImagination(
    request: ImaginationRequest,
    userId: Long = ImaginationParameters.USER_ID,
) = perform(
    MockMvcRequestBuilders
        .post(BASE_URL)
        .header(HttpHeaderName.USER_ID, userId)
...
fun MockMvc.completeImagination(
    id: Long,
    userId: Long = ImaginationParameters.USER_ID,
) = perform(
    MockMvcRequestBuilders
        .post("$BASE_URL/complete/$id")
        .header(HttpHeaderName.USER_ID, userId),
)
